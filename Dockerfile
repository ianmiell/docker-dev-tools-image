...
###############
# Network tools
# curl net-tools nmap wget whois socat openssh-client openssh-server openssl libwww-perl nettcp
...
###############
# System debugging
# iotop strace tcpdump iproute ltrace lsof inotify-tools sysstat ddd tshark
###############
# Finding files
# mlocate
###############
